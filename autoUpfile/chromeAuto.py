    ...
    if len(username_pwd) > 0:
        ...
        if canUpfile:
            ...
            while len(typeInput) == 0 and not isTimeOut(startTime):
                sleep()
                typeInput = driver.find_elements_by_xpath('//*[@id="upload_info"]/div/div[3]/div[2]/div[2]/form/div[3]/div/div/div[1]/div[1]/input')
            if len(typeInput) > 0:
                typeInput[0].click()
            ...
            #     progress_bar = driver.find_elements_by_xpath('//*[@id="upload_info"]/div/div[3]/div[2]/div[2]/div/div[1]/div[1]/div/div')
